...
import { App, Modal, Select, Typography, Row, Col, Tag, Button } from "antd";
...
import ConfirmInfoWithdraw from "./confirm.info.withdraw";
import ConfirmInfoReplace from "./confirm.info.replace";

const { Option } = Select;
const { Text } = Typography;

const CreateReplaceModal = (props) => {
  const { openModalReplace, setOpenModalReplace, documentId } = props;
...
export default CreateReplaceModal;
