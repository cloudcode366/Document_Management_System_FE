...
import DrawerSchoolDocument from "./drawer.school.document";
          ...
          request={async (params) => {
            ...
            if (activeKey === "Rejected") {
              if (params) {
                ...
                query += `scope=School&userId=${user.userId}&tab=${activeKey}&page=${params.current}&limit=${params.pageSize}`;
              }
            } else {
              if (params) {
