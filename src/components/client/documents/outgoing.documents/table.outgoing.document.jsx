...
import DrawerOutgoingDocument from "./drawer.outgoing.document";
          ...
          request={async (params) => {
            ...
            if (activeKey === "Rejected") {
              if (params) {
                ...
                query += `scope=OutGoing&userId=${user.userId}&tab=${activeKey}&page=${params.current}&limit=${params.pageSize}`;
              }
            } else {
              if (params) {
